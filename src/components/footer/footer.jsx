    ...
    >
        <div className="container">
            <div className="columns" style={{ marginTop: '70px' }}>
                ...
                >
                    <div className="footer-column">
                        ...
                        <p style={{ fontSize: '14px' }}>Mexico.FrenaLaCurva.net una red de apoyo de personas voluntarias que conecta esfuerzos de y acciones ciudadanas para aplanar la curva y mitigar los efectos del COVID-19 en México. Forma parte de <a className="has-text-white has-text-weight-bold" href="http://frenalacurva.net/">FrenaLaCurva.Net</a> que está bajo una <a className="has-text-white has-text-weight-bold" href="http://creativecommons.org/licenses/by/2.0/es/"> licencia de Creative Commons Reconocimiento 2.0 España</a>.
                        </p>
                    </div>
                </div>
            ...
            <div className="level Footer-navbar">
                <div className="level-left">
                    <a className="has-text-white level-item" href="/">INICIO</a>
                    <a className="has-text-white level-item" href="https://mx.frenalacurva.net/">FORO</a>
                    <a className="has-text-white level-item" href="/mapa">MAPA</a>
                </div>
                <div className="level-right">
                    <a className="has-text-white level-item" href="https://www.facebook.com/frenalacurvamx/">FRENA LA CURVA MÉXICO © 2020</a>
                </div>
            </div>
        </div>
    </footer>
