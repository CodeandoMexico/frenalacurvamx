    ...
    <section className="section mb-20 initiatives">
        <div className="container">
            <div className="has-text-centered">
                ...
                <h3 className="subtitle is-muted">Conoce las <strong>iniciativas de solidaridad</strong> que han brotado en estos últimos días, van desde dar una clase online, compartir el directorio de los negocios locales hasta formar parte de un grupo de makers para crear distintas soluciones.</h3>
                <h3 className="subtitle is-muted">Desde la sociedad civil, desde nuestras organizaciones sociales, nuestras empresas o nuestra propia familia, <strong>JUNTXS como ciudadanía podemos hacerle frente al #COVID19</strong>.</h3>
            </div>
