        ...
        <div style={{fontFamily:"'Spartan', sans-serif", marginTop:"65px", marginBottom:"60px"}} className="container">
            <div style={{padding:"100px", paddingTop:"15px"}} className="columns">
                <div style={{padding:"50px", paddingTop:"100px", paddingLeft:"100px"}} className="column is-two-thirds">
                    ...
                    <h4 style={{fontSize:"24px", fontWeight:"bold", color:"#E84652"}}>Aporta ideas, suma tu creatividad y energía. </h4>
                    <h4 style={{fontSize:"24px", fontWeight:"bold", marginTop:"30px"}}>Convocamos a personas que quieran colaborar y experimentar nuevas posibilidades de ayuda en tiempos del COVID-19.</h4>
                    <a href="https://bit.ly/labsdistribuidos-colaboradores" target="blank"><button style={{marginTop:"30px"}} className="button cta is-rounded primary-btn raised">QUIERO UNIRME</button></a>
