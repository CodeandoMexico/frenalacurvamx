            ...
            <div className="columns is-vcentered">
                ...
                <div className="column is-3 landing-caption">
                    <h1 className="title is-1 is-bold is-spaced">
                        Frena <br />la curva<br />México
                    </h1>
                    <h2 className="subtitle is-5 is-muted">Guía de iniciativas ciudadanas frente al coronavirus (COVID-19), innovación social y resiliencia cívica en tiempos de pandemia.</h2>
