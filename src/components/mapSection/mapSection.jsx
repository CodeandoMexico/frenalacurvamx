...
const MapaMexico = require("../../images/illustrations/Mapa_Mexico.svg")
const MapSection = ()=>(
    <section>
        ...
        <div class="columns is-mobile">
            ...
            <div className="column is-half-mobile" style={{fontFamily:"'Spartan', sans-serif", zIndex:"10"}}>
                ...
                <div className="container">
                    ...
                    <a href="https://mx.mapa.frenalacurva.net/" target="blank"><button className="button-mapa-mobile column button cta is-rounded primary-btn raised">IR AL MAPA</button></a>
