                    ...
                    <div className={`navbar-menu is-shadowless ${isActiveClassnName}`}>
                        ...
                        <div className="navbar-end">
                            ...
                            <div className="navbar-item-social">
                                ...
                                <a href="https://twitter.com/frenalacurvamx" onClick={toggleActive} target="_blank" rel="noopener noreferrer" title="Visita nuestro Twitter">
                                    <img className="navbar-item-social-logo" src={logoTW} alt="Twitter" />
                                </a>
                                <a href="https://www.instagram.com/frenalacurvamx/" onClick={toggleActive} target="_blank" rel="noopener noreferrer" title="Visita nuestro Instagram">
